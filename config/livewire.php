...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        // 256MB, matching upload_max_filesize/post_max_size in the Dockerfile.
        // Livewire's built-in default is only 12MB, which silently rejects a
        // release APK: the browser shows the upload reaching 100% and then
        // hangs, because the rejection happens on Livewire's own temporary
        // upload endpoint before Filament ever sees the file.
        'rules' => ['required', 'file', 'max:262144'],        // in KILOBYTES
        ...
        // 15 minutes, not 5: a large APK over a slow mobile/home connection can
        // legitimately take longer than the default before it finishes.
